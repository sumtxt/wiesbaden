...
Alternatively, if you use Linux or Mac, you can use `save_credentials()` to generate a file named '.genesis.json' in your root directory that includes your login and password. Please note that this file is unencrypted. If this file exists, the argument `genesis` only needs to include the database shortname. 
