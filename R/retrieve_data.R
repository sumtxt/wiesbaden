...
retrieve_data <- function(
	...
	if(restapi){
	  ...
	  baseurl <- paste(set_db(db=genesis['db'], restapi), "data/cube", sep="")
	  ...
	  param <- list(
	    ...
	    endyear = endyear,
	    timeslices = '',
	    regionalvariable = regionalmerkmal,
	    regionalkey = regionalschluessel,
	    classifyingvariable1 = sachmerkmal,
	    classifyingkey1 = sachschluessel,
	    classifyingvariable2 = sachmerkmal2,
	    classifyingkey2 = sachschluessel2,
	    classifyingvariable3 = sachmerkmal3,
	    classifyingkey3 = sachschluessel3,
	    format = 'csv',
	    stand = '',
	    language = 'de')
	  ...
	  DQERH  <- paste("id", tabs[[3]]$V2[2],"_rest", sep="")
	...
	baseurl <- paste(set_db(db=genesis['db'], restapi = FALSE), "ExportService_2010", sep="")
